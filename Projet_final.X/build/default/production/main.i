...
void servo_open(void) {
    unsigned char i;
    for(i = 0; i < 50; i++) {
        RB3 = 1; _delay((unsigned long)((1000)*(4000000/4000000.0)));
        RB3 = 0; _delay((unsigned long)((19)*(4000000/4000.0)));
    }
}
...
void servo_close(void) {
    unsigned char i;
    for(i = 0; i < 50; i++) {
        RB3 = 1; _delay((unsigned long)((2000)*(4000000/4000000.0)));
        RB3 = 0; _delay((unsigned long)((18)*(4000000/4000.0)));
    }
}
...
void main(void) {
    ...
    do { RB4 = 0; RB5 = 1; } while(0);
    do { RB1 = 0; RB2 = 1; } while(0);
    servo_open();
    ...
    while(1) {
        ...
        if(RA0 == 0 && etat_jour == 0) {
            etat_jour = 1;
            do { RB4 = 0; RB5 = 1; } while(0);
            if(!porte_etat) { servo_open(); porte_etat = 1; }
            sec = 0; tmr = 0;
            do { RB1 = 0; RB2 = 1; } while(0); etat_relais = 1;
        }
        else if(RA0 == 1 && etat_jour == 1) {
            etat_jour = 0;
            do { RB4 = 1; RB5 = 0; } while(0);
